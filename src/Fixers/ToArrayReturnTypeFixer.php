...
class ToArrayReturnTypeFixer extends BaseFixer implements IFixer {
    ...
    {
        return "::toArray() return type has no value type specified in iterable type array";
    }

    public function fix(FileSummaryDto $file, ErrorMessageDto $error): bool
    {
        return $this->addOnMethodComment("@return array<mixed>", $file, "toArray");
    }
}
